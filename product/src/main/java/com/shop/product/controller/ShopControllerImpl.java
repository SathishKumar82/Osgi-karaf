...
public class ShopControllerImpl implements ShopController {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @GET
    public Map selectProduct(@QueryParam("brand") final String brand, @QueryParam("name") final String name, @QueryParam("size") final String size) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @PUT
    public Map updateProduct(final List<Product> products) {
